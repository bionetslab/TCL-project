...
def run(adata_pickle_path, user_selected_cluster_level):
    ...
    # pickle_=pickle_new
    # ---
    all_items = pickle_items[115:116]
    ...
    for i in pickle_:
        ...
        try:
            ...
            for k in range(1, cluster_level_max_int-1):
                ...
                if k==selected_cluster_level:
                    sc.pl.dotplot(adata_raw, allEssentialProteins_acrossClusterLevels_forAllPatients[i][k], groupby=_clust_name_, ax=axes, save=f"____PatientID-{i}_____ClusteringLevel-{k}__finalSelected")
                else:
    ...
    with open('essential_proteins115.pkl', 'wb') as f:
