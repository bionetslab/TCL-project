from melc import DAsquidpy_Ripley_Statistics
import argparse
...
if __name__ == '__main__':
    ...
    DAsquidpy_Ripley_Statistics.dasquidpy_ripley_statistics(args.adata_pickle_path, args.dependent_variable_name)