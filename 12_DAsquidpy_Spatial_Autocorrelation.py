from melc import DAsquidpy_Spatial_Autocorrelation
import argparse
...
if __name__ == '__main__':
    ...
    DAsquidpy_Spatial_Autocorrelation.dasquidpy_spatial_autocorrelation(args.adata_pickle_path, args.dependent_variable_name)